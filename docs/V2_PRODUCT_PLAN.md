...
| 배포 | release commit `48b76d2…`의 V2 최초 공개 리비전 `minutemark-00012-luh` | 공개 health·브라우저 스모크 PASS |
...
main SHA의 0% 리비전 health를 확인한 뒤 V2 트래픽을 공개했다. 로컬 검증을 위해
...
3번을 확인하고, 실제 업무·기밀·민감정보 업로드 금지와 A6API 전사문 전송을
...
[`V2_1_RELEASE_PLAN.md`](./V2_1_RELEASE_PLAN.md)를 활성 정본으로 사용한다.
