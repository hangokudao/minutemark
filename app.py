...
SAMPLES = {
    ...
    "kmsav-01": {
        "filename": "kmsav-01-07zhNSvDR0A.wav",
        "title": "여수 시사데스크 토론",
        "description": "지역 문화시설 운영을 다루는 다화자 시사 토론 60초 공개 발화",
        "source_title": "여수MBC토론 - 시사데스크(2015.05.15 / 18:00~19:15)",
        "source_url": "https://www.youtube.com/watch?v=07zhNSvDR0A",
        "author": "GS칼텍스 예울마루",
        "license": "KMSAV CC BY-NC-SA 4.0; original Creative Commons Attribution (CC BY)",
        "license_url": "https://github.com/etri/kmsav",
        "modification": "60초 발췌·16 kHz mono WAV 변환",
        "duration_seconds": 60,
    },
    "kmsav-03": {
        "filename": "kmsav-03-9g6USDTbGhg.wav",
        "title": "전남도 교육감 인터뷰",
        "description": "교육 정책과 학생 프로그램을 다루는 공식 인터뷰 60초 공개 발화",
        "source_title": "[피플인사이드] 장만채 전남도 교육감",
        "source_url": "https://www.youtube.com/watch?v=9g6USDTbGhg",
        "author": "KBC 콘텐츠",
        "license": "KMSAV CC BY-NC-SA 4.0; original Creative Commons Attribution (CC BY)",
        "license_url": "https://github.com/etri/kmsav",
        "modification": "60초 발췌·16 kHz mono WAV 변환",
    ...
    "kmsav-04": {
        "filename": "kmsav-04-0e76Mv3YWso.wav",
        "title": "치매 예방 과학 Q&A",
        "description": "뇌과학 전문 용어가 포함된 질의응답 60초 공개 발화",
        "source_title": "[질문Q] 치매를 미리 예방할 수 있을까?ㅣ2016 봄 카오스 강연 '뇌 - Brain' 6강ㅣ영화로 만나는 뇌과학",
        "source_url": "https://www.youtube.com/watch?v=0e76Mv3YWso",
        "author": "카오스 사이언스",
        "license": "KMSAV CC BY-NC-SA 4.0; original Creative Commons Attribution (CC BY)",
        "license_url": "https://github.com/etri/kmsav",
        "modification": "60초 발췌·16 kHz mono WAV 변환",
    ...
    "kmsav-05": {
        "filename": "kmsav-05-3uuLmiV-HNI.wav",
        "title": "뇌·포만감 연구 Q&A",
        "description": "연구 현황과 실험 설계를 설명하는 과학 질의응답 60초 공개 발화",
        "source_title": "[질문Q] 뇌를 조작해서 포만감을 느끼게 할 수 있다? | 2017 가을 카오스 강연 '미래과학' 3강 | 뇌 커넥톰, 마음을 볼 수 있을까?",
        "source_url": "https://www.youtube.com/watch?v=3uuLmiV-HNI",
        "author": "카오스 사이언스",
        "license": "KMSAV CC BY-NC-SA 4.0; original Creative Commons Attribution (CC BY)",
        "license_url": "https://github.com/etri/kmsav",
        "modification": "60초 발췌·16 kHz mono WAV 변환",
    ...
    "kmsav-06": {
        "filename": "kmsav-06-0FzNHep2onE.wav",
        "title": "시사 대담 다화자 토론",
        "description": "법적 쟁점과 토론 맥락이 섞인 다화자 시사 대담 60초 공개 발화",
        "source_title": "4.15 부정선거 시사대담 / 이재명, 생환 / 유승수 변호사 (3/4) [공병호TV]",
        "source_url": "https://www.youtube.com/watch?v=0FzNHep2onE",
        "author": "공병호TV",
        "license": "KMSAV CC BY-NC-SA 4.0; original Creative Commons Attribution (CC BY)",
        "license_url": "https://github.com/etri/kmsav",
        "modification": "60초 발췌·16 kHz mono WAV 변환",
    ...
    "kmsav-07": {
        "filename": "kmsav-07-9h7CCmpcirA.wav",
        "title": "자치분권 특강",
        "description": "지방자치와 협력 체계를 설명하는 공공 정책 특강 60초 공개 발화",
        "source_title": "[자치분권대학 특강] 똑똑, 자치분권입니다 5화",
        "source_url": "https://www.youtube.com/watch?v=9h7CCmpcirA",
        "author": "젬비씨 JEMBC",
        "license": "KMSAV CC BY-NC-SA 4.0; original Creative Commons Attribution (CC BY)",
        "license_url": "https://github.com/etri/kmsav",
        "modification": "60초 발췌·16 kHz mono WAV 변환",
    ...
    "kmsav-08": {
        "filename": "kmsav-08-9vY0YzdjoMU.wav",
        "title": "시사 토크 다화자 대화",
        "description": "빠른 말투의 다화자 시사 토크 60초 공개 발화",
        "source_title": "김만배, 현직기자가 윤석열의 검찰총장 청문회를 같이 준비하다니? | 김성수 김성회 쌍김시대 (짤)",
        "source_url": "https://www.youtube.com/watch?v=9vY0YzdjoMU",
        "author": "김성수TV 성수대로",
        "license": "KMSAV CC BY-NC-SA 4.0; original Creative Commons Attribution (CC BY)",
        "license_url": "https://github.com/etri/kmsav",
        "modification": "60초 발췌·16 kHz mono WAV 변환",
    ...
    "kmsav-10": {
        "filename": "kmsav-10-9bTYC7hkWAI.wav",
        "title": "리만·기하 수학 Q&A",
        "description": "전문 수학 용어가 포함된 과학 강연 질의응답 60초 공개 발화",
        "source_title": "[질문Q] 가우스도 놀란 리만의 강의는? | 2018 봄 카오스 강연 '모든 것의 수數다' 5강 | 고차원 비유클리드 공간으로의 초대",
        "source_url": "https://www.youtube.com/watch?v=9bTYC7hkWAI",
        "author": "카오스 사이언스",
        "license": "KMSAV CC BY-NC-SA 4.0; original Creative Commons Attribution (CC BY)",
        "license_url": "https://github.com/etri/kmsav",
        "modification": "60초 발췌·16 kHz mono WAV 변환",
